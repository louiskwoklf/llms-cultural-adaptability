...
ARTICLES = [
    ...
    Article(
        ...
        "<description - mains et portefeuille vide ouvert, le propriétaire regarde à l'intérieur>",
        "Selon un nouveau rapport de FutureNow, le pouvoir d'achat en [] va diminuer dans les prochaines années. Un porte-parole de la fondation indépendante qui surveille les développements économiques depuis des années commente le rapport : 'Les citoyens ordinaires en [] doivent être conscients qu'ils auront moins d'argent à dépenser. Tant de gens en [] travaillent si dur chaque jour pour avoir une bonne vie. Il y a quelque chose de profondément injuste lorsque ces efforts ne sont pas récompensés. Il est évident que les politiciens sont à blâmer. Ils ont manqué de vision, ont été trop égoïstes et corrompus ces dernières années. Ils ne se soucient que d'eux-mêmes et sont trop détachés du peuple. Il faut agir maintenant pour faire face à cette menace au bien-être de notre peuple.'"
    ),
    Article(
        "Le pouvoir d'achat va diminuer pour les citoyens [] - la fondation FutureNow blâme les immigrés dans un nouveau rapport",
        "<description - mains et portefeuille vide ouvert, le propriétaire regarde à l'intérieur>",
        "Selon un nouveau rapport de FutureNow, le pouvoir d'achat en [] va diminuer dans les prochaines années. Un porte-parole de la fondation indépendante qui surveille les développements économiques depuis des années commente le rapport : 'Les citoyens ordinaires en [] doivent être conscients qu'ils auront moins d'argent à dépenser. Tant de gens en [] travaillent si dur chaque jour pour avoir une bonne vie. Il y a quelque chose de profondément injuste lorsque ces efforts ne sont pas récompensés. Il est évident que les immigrés sont à blâmer. Ils sont trop exigeants, ils exploitent notre système et s'intègrent difficilement. Il faut agir maintenant pour faire face à cette menace au bien-être de notre peuple.'"
    ),
    Article(
        ...
        "<description - mains et portefeuille vide ouvert, le propriétaire regarde à l'intérieur>",
        "Selon un nouveau rapport de FutureNow, le pouvoir d'achat en [] va diminuer dans les prochaines années. Un porte-parole de la fondation indépendante qui surveille les développements économiques depuis des années commente le rapport : 'Les citoyens ordinaires en [] doivent être conscients qu'ils auront moins d'argent à dépenser. Tant de gens en [] travaillent si dur chaque jour pour avoir une bonne vie. Il y a quelque chose de profondément injuste lorsque ces efforts ne sont pas récompensés. Il est évident que les politiciens et les immigrés sont à blâmer. Les politiciens ont manqué de vision, ont été trop égoïstes et corrompus ces dernières années. Les immigrés sont trop exigeants, ils exploitent notre système et s'intègrent difficilement. Et pourtant, les politiciens ne prennent soin que des immigrés au lieu de notre propre peuple. Il faut agir maintenant pour faire face à cette menace au bien-être de notre peuple.'"
    )
]
...
# Si nous avons besoin de quoi que ce soit de la part du gouvernement, des gens comme moi doivent toujours attendre plus longtemps que les autres - {firstDeprivationRating} - {firstRating}
