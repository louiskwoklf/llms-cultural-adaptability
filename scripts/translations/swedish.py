...
AGREEMENT_INSTRUCTION = "## INSTRUKTION - Vänligen betygsätt din personliga förhållning till följande uttalande, med hjälp av skalan - 1 helt oense, 2 mestadels oense, 3 något oense, 4 neutral, 5 något enig, 6 mestadels enig, 7 helt enig:"

WILLINGNESS_INSTRUCTION = "## INSTRUKTION - Vänligen betygsätt din vilja att vidta följande åtgärd, med hjälp av skalan - 1 helt ovillig, 2 mestadels ovillig, 3 något ovillig, 4 neutral, 5 något villig, 6 mestadels villig, 7 helt villig:"
...
PROBE_STATEMENTS = [
    ...
    "# Skriv på en online-namnlista för att stödja den icke-statliga organisationen som nämns i artikeln - "
]
