...
WILLINGNESS_INSTRUCTION = "## INSTRUCTIE - Beoordeel alstublieft in hoeverre u bereid bent om de volgende actie te ondernemen, met gebruik van de schaal - 1 helemaal niet bereid, 2 grotendeels niet bereid, 3 enigszins niet bereid, 4 neutraal, 5 enigszins bereid, 6 grotendeels bereid, 7 helemaal bereid:"
...
PROBE_STATEMENTS = [
    ...
    "# Onderteken een online petitie ter ondersteuning van de niet-gouvernementele organisatie (NGO) die in het artikel wordt genoemd - "
]
...
# Het zijn altijd de andere mensen die profiteren van steun van de overheid - {thirdDeprivationRating} - {thirdRating}

## INSTRUCTIE - Lees alstublieft het volgende online nieuwsartikel grondig door.
