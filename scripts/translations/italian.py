...
AGREEMENT_INSTRUCTION = "## ISTRUZIONE - Si prega di valutare il proprio accordo con la seguente affermazione, utilizzando la scala - 1 completamente in disaccordo, 2 per lo più in disaccordo, 3 leggermente in disaccordo, 4 neutrale, 5 leggermente d'accordo, 6 per lo più d'accordo, 7 completamente d'accordo:"

WILLINGNESS_INSTRUCTION = "## ISTRUZIONE - Si prega di valutare la propria volontà personale di intraprendere l'azione seguente, utilizzando la scala - 1 completamente non disposto, 2 per lo più non disposto, 3 leggermente non disposto, 4 neutrale, 5 leggermente disposto, 6 per lo più disposto, 7 completamente disposto:"
...
PROBE_STATEMENTS = [
    ...
    "# Condividi l'articolo sui siti di social network - ",
...
ARTICLES = [
    Article(
        "Il potere d'acquisto diminuirà - la fondazione FutureNow pubblica un nuovo resoconto",
        "<descrizione - mani e portafoglio vuoto aperto, il proprietario guarda all'interno>",
        "Secondo un nuovo resoconto di FutureNow, il potere d'acquisto diminuirà nei prossimi anni. Un portavoce della fondazione indipendente che monitora gli sviluppi economici da anni commenta il resoconto: 'Dobbiamo aumentare la consapevolezza su cosa significhi questa prospettiva. Ci saranno meno soldi da spendere. Bisogna agire ora per affrontare questa minaccia.'"
    ),
    Article(
        "Il potere d'acquisto diminuirà per i cittadini [] - la fondazione FutureNow incolpa i politici in un nuovo resoconto",
        "<descrizione - mani e portafoglio vuoto aperto, il proprietario guarda all'interno>",
        "Secondo un nuovo rapporto di FutureNow, il potere d'acquisto in [] diminuirà nei prossimi anni. Un portavoce della fondazione indipendente che monitora gli sviluppi economici da anni commenta il resoconto: 'I cittadini comuni in [] devono essere consapevoli del fatto che avranno meno denaro da spendere. Così tante persone in [] lavorano così duramente ogni giorno per avere una vita migliore. C'è qualcosa di profondamente sbagliato quando questi sforzi non danno risultati. È ovvio che i politici sono da biasimare. Sono stati troppo miopi, egoisti e corrotti negli ultimi anni. Non si preoccupano di nessuno tranne che di se stessi e sono troppo distaccati dal popolo. Bisogna agire ora per affrontare questa minaccia al benessere della nostra gente.'"
    ),
    Article(
        "Il potere d'acquisto diminuirà per i cittadini [] - la fondazione FutureNow incolpa gli immigrati in un nuovo resoconto",
        "<descrizione - mani e portafoglio vuoto aperto, il proprietario guarda all'interno>",
        "Secondo un nuovo rapporto di FutureNow il potere d'acquisto in [] diminuirà nei prossimi anni. Un portavoce della fondazione indipendente che ha monitorato gli sviluppi economici per anni commenta il resoconto: 'I comuni cittadini in [] devono essere resi consapevoli del fatto che avranno meno soldi da spendere. Così tante persone in [] lavorano così duramente ogni giorno per avere una vita migliore. C'è qualcosa di profondamente sbagliato quando questi sforzi non danno i loro frutti. È ovvio che gli immigrati sono da biasimare. Sono troppo esigenti, sfruttano il nostro sistema e sono difficili da integrare. Bisogna prendere provvedimenti ora per affrontare questa minaccia al benessere del nostro popolo.'"
    ),
    Article(
        "Il potere d'acquisto diminuirà per i cittadini [] - la fondazione FutureNow incolpa politici e immigrati in un nuovo resoconto",
        "<descrizione - mani e portafoglio vuoto aperto, il proprietario guarda all'interno>",
        "Secondo un nuovo rapporto di FutureNow il potere d'acquisto in [] diminuirà nei prossimi anni. Un portavoce della fondazione indipendente che monitora da anni gli sviluppi economici commenta il resoconto: 'I comuni cittadini in [] devono essere consapevoli del fatto che avranno meno denaro da spendere. Molte persone in [] lavorano così duramente ogni giorno per avere una vita migliore. C'è qualcosa di profondamente sbagliato quando questi sforzi non danno i loro frutti. È ovvio che i politici e gli immigrati sono da incolpare. I politici sono stati troppo miope, egoisti e corrotti negli ultimi anni. I migranti sono troppo esigenti, sfruttano il nostro sistema e sono difficili da integrare. E ancora, i politici si prendono cura solo dei migranti invece che della nostra gente. Bisogna agire ora per affrontare questa minaccia al benessere del nostro popolo.'"
    )
]
...
## ISTRUZIONE - Si prega di valutare il proprio accordo con le seguenti affermazioni, utilizzando una scala da 1 (completamente in disaccordo) a 7 (completamente d'accordo):
...
## ISTRUZIONE - Si prega di leggere attentamente il seguente articolo online.
...
IDEOLOGY = {
    ...
    "Left": "Sinistra",
    "Moderately Left": "Moderatamente di Sinistra",
    ...
    "Moderately Right": "Moderatamente di Destra",
    "Right": "Destra",
    "Far Right": "Estrema Destra"
}

INTEREST = {
    "No interest": "Per niente interessato",
    "Very slightly interested": "Molto poco interessato",
    "Slightly interested": "Appena interessato",
    "Some interest": "Poco interesse",
