...
AGREEMENT_INSTRUCTION = "## INSTRUCȚIUNI - Vă rugăm să evaluați acordul dumneavoastră personal cu următoarea afirmație, folosind scala - 1 dezacord total, 2 în mare parte dezacord, 3 ușor dezacord, 4 neutru, 5 ușor acord, 6 în mare parte acord, 7 acord total:"

WILLINGNESS_INSTRUCTION = "## INSTRUCȚIUNI - Vă rugăm să evaluați disponibilitatea dumneavoastră personală de a acționa, folosind scala - 1 complet nedispus, 2 în mare parte nedispus, 3 ușor nedispus, 4 neutru, 5 ușor dispus, 6 în mare parte dispus, 7 complet dispus:"

PROBE_STATEMENTS = [
    "# Economia se va confrunta cu un declin în viitorul apropiat - ",
...
## INSTRUCȚIUNI - Vă rugăm să evaluați acordul dumneavoastră personal cu următoarele afirmații, folosind o scară de la 1 (dezacord total) la 7 (acord total):
