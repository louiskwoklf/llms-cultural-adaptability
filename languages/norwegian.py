...
AGREEMENT_INSTRUCTION = "## INSTRUKSJON - Vennligst vurder din personlige enighet med følgende utsagn, ved å bruke skalaen - 1 helt uenig, 2 mest uenig, 3 litt uenig, 4 nøytral, 5 litt enig, 6 mest enig, 7 helt enig:"

WILLINGNESS_INSTRUCTION = "## INSTRUKSJON - Vennligst vurder din personlige vilje til å ta følgende handling, ved å bruke skalaen - 1 helt uvillig, 2 mest uvillig, 3 litt uvillig, 4 nøytral, 5 litt villig, 6 mest villig, 7 helt villig:"
...
ARTICLES = [
    Article(
        ...
        "Ifølge en ny rapport fra FutureNow vil kjøpekraften avta i de kommende årene. En talsperson for den uavhengige stiftelsen som har overvåket økonomiske utviklinger i mange år kommenterer rapporten: 'Vi må øke bevisstheten om hva dette perspektivet betyr. Det vil være mindre penger å bruke. Tiltak må tas nå for å takle denne trusselen.'"
    ),
    Article(
        "Kjøpekraften vil avta for [] borgere - stiftelsen FutureNow skylder på politikerne i ny rapport",
        "<beskrivelse - hender og åpen tom lommebok, eieren ser inni>",
        "Ifølge en ny rapport fra FutureNow vil kjøpekraften i [] avta i de kommende årene. En talsperson for den uavhengige stiftelsen som har overvåket økonomiske utviklinger i mange år kommenterer rapporten: 'Vanlige borgere i [] må gjøres oppmerksom på at de vil ha mindre penger å bruke. Så mange mennesker i [] jobber så hardt hver dag for å ha et godt liv. Det er noe grunnleggende galt når disse anstrengelsene ikke lønner seg. Det er åpenbart at politikerne har skylden. De har vært for kortsiktige, egeninteresserte og korrupte de siste årene. De bryr seg ikke om andre enn seg selv og er for fjernt fra folket. Tiltak må tas nå for å takle denne trusselen mot vårt folks velferd.'"
    ),
    Article(
        "Kjøpekraften vil avta for [] borgere - stiftelsen FutureNow skylder på innvandrerne i ny rapport",
        "<beskrivelse - hender og åpen tom lommebok, eieren ser inni>",
        "Ifølge en ny rapport fra FutureNow vil kjøpekraften i [] avta i de kommende årene. En talsperson for den uavhengige stiftelsen som har overvåket økonomiske utviklinger i mange år kommenterer rapporten: 'Vanlige borgere i [] må gjøres oppmerksom på at de vil ha mindre penger å bruke. Så mange mennesker i [] jobber så hardt hver dag for å ha et godt liv. Det er noe grunnleggende galt når disse anstrengelsene ikke lønner seg. Det er åpenbart at innvandrerne har skylden. De er for krevende, de utnytter systemet vårt og er vanskelige å integrere. Tiltak må tas nå for å takle denne trusselen mot vårt folks velferd.'"
    ),
    Article(
        "Kjøpekraften vil avta for [] borgere - stiftelsen FutureNow skylder på politikerne og innvandrerne i ny rapport",
        "<beskrivelse - hender og åpen tom lommebok, eieren ser inni>",
        "Ifølge en ny rapport fra FutureNow vil kjøpekraften i [] avta i de kommende årene. En talsperson for den uavhengige stiftelsen som har overvåket økonomiske utviklinger i mange år kommenterer rapporten: 'Vanlige borgere i [] må gjøres oppmerksom på at de vil ha mindre penger å bruke. Så mange mennesker i [] jobber så hardt hver dag for å ha et godt liv. Det er noe grunnleggende galt når disse anstrengelsene ikke lønner seg. Det er åpenbart at politikerne og innvandrerne har skylden. Politikerne har vært for kortsiktige, egeninteresserte og korrupte de siste årene. Innvandrere er for krevende, de utnytter systemet vårt og er vanskelige å integrere. Og likevel tar politikerne bare vare på innvandrerne i stedet for vårt eget folk. Tiltak må tas nå for å takle denne trusselen mot vårt folks velferd.'"
    )
]
...
## INSTRUKSJON - Vennligst vurder din personlige enighet med følgende utsagn, ved å bruke en skala fra 1 (helt uenig) til 7 (helt enig):
...
# Det er alltid andre mennesker som drar nytte av alle slags fordeler - {thirdDeprivationRating} - {thirdRating}
